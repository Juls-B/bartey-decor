...
import yellowLounge from "@/assets/yellow-lounge.jpg.asset.json";
import armchairBoucle from "@/assets/armchair-boucle.jpg.asset.json";
import greyAccentChair from "@/assets/grey-accent-chair.jpg.asset.json";
...
export const collections: Collection[] = [
  {
    ...
    image: wardrobeFitted.url,
    heroImage: wardrobeFitted.url,
  },
  {
    id: "tv-consoles",
    name: "TV Consoles",
    ...
    image: tvConsoleMarble.url,
    heroImage: tvConsoleMarble.url,
  },
  {
    id: "living-room",
    ...
    image: warmLivingRoom.url,
    heroImage: warmLivingRoom.url,
  },
  {
    id: "home-styling",
    name: "Home Styling",
    ...
    image: armchairBoucle.url,
    heroImage: armchairBoucle.url,
  },
  {
    id: "bedroom",
    name: "Bedroom",
  ...
  },
  {
    ...
    image: officeReception.url,
    heroImage: officeReception.url,
  },
];
...
export const products: Product[] = [
  // Custom Wardrobes
  {
    ...
    images: [wardrobeFitted.url, wardrobeFitted.url],
    featured: true,
  },
  {
    ...
    images: [wardrobeFitted.url, warmLivingRoom.url],
    new: true,
  },
  ...
  // TV Consoles
  {
    ...
    images: [tvConsoleMarble.url, tvConsoleModern.url],
    featured: true,
  },
  {
    id: "floating-tv-unit",
    ...
    images: [tvConsoleModern.url, tvConsoleMarble.url],
    new: true,
  },
  ...
  // Living Room
  {
    ...
    images: [greenSofa.url, warmLivingRoom.url],
    featured: true,
  },
  {
    id: "warm-living-set",
    ...
    images: [warmLivingRoom.url, greenSofa.url],
  },
  ...
  // Home Styling
  {
    ...
    images: [armchairBoucle.url, greyAccentChair.url],
    new: true,
  },
  {
    ...
    images: [greyAccentChair.url, armchairBoucle.url],
  },
  ...
  // Bedroom
  {
    ...
    images: [warmLivingRoom.url, wardrobeFitted.url],
  },
  ...
  // Commercial
  {
    ...
    images: [officeReception.url, tvConsoleMarble.url],
    featured: true,
  },
  {
    id: "salon-lounge-set",
    ...
    images: [yellowLounge.url, officeReception.url],
    new: true,
  },
];
